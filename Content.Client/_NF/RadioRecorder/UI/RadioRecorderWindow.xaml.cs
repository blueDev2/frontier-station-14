...
public sealed partial class RadioRecorderWindow : FancyWindow
{
    private readonly ButtonGroup _buttonGroup = new();

    private readonly RadioRecorderBoundUserInterface _owner;

    public RadioRecorderWindow(RadioRecorderBoundUserInterface owner)
    {
